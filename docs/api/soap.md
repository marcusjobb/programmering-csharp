---
title: SOAP
description: "SOAP (Simple Object Access Protocol) är ett äldre, XML-baserat protokoll för att anropa API:er — vanligt i företagsvärlden och starkt förknippat med…"
parent: APIer
nav_order: 3
---
# SOAP
