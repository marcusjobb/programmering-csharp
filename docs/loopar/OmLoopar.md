...
Loopar är en viktig del av programmering som används för att upprepa ett block av kod tills ett visst villkor är uppfyllt. Det finns flera olika typer av loopar som kan användas i C#, inklusive for, while, do-while och foreach.
